...
## IdentityCommand.SCA Issues

If you find an error in `IdentityCommand.SCA`, or have a question relating to the module, [log an issue][new-issue].
...
New-ExternalHelp -Path .\docs\collections\_commands\ -OutputPath .\IdentityCommand.SCA\en-US\IdentityCommand.SCA-help.xml -Force
```

[commit]: http://tbaggery.com/2008/04/19/a-note-about-git-commit-messages.html
[OTBS]: https://github.com/PoshCode/PowerShellPracticeAndStyle/issues/81
[new-issue]: https://github.com/pspete/IdentityCommand.SCA/issues/new
[dev-branch]: https://github.com/pspete/IdentityCommand.SCA/tree/dev
[command-help]: https://github.com/pspete/IdentityCommand.SCA/tree/master/docs/collections/_commands
