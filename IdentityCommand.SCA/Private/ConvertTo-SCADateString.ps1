function ConvertTo-SCADateString {
    <#
    .SYNOPSIS
    Formats a date for the SCA API.

    .DESCRIPTION
    Policy start/end dates are sent as UTC ISO 8601 strings (for example 2022-07-12T00:00:00.000Z).
    ...
    .EXAMPLE
    ConvertTo-SCADateString -Date (Get-Date '2022-07-12')
