function Add-SCAQueryString {
    ...
    Most SCA endpoints also accept a 'debug' query parameter which enriches the API's error payload.
    ...
    .EXAMPLE
    $URI = Add-SCAQueryString -URI $URI -Parameter @{ limit = 100 }
    #>
    [OutputType([string])]
    [CmdletBinding()]
    param(
