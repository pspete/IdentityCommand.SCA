function ConvertTo-SCAJsonBody {
    <#
    .SYNOPSIS
    Serialises a request body object to a JSON string for the SCA API.
    ...
    as a JSON array. It also gives every SCA body a single consistent default depth.
    ...
    .EXAMPLE
    $body = ConvertTo-SCAJsonBody -Body $Properties -Depth 3
    #>
    [OutputType([string])]
    [CmdletBinding()]
    param(
